...
#Cross table of variable and number of variable in training data, showing 60 raw variables and 100 summary variables
table(apply(data, 2, function(x){sum(!is.na(x))}))          
#Cross table of variable and number of variable in testing data, showing 60 raw variables and 100 summary variables
